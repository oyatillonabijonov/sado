 ...
 * tepada. Kerak bo'lsa checkbox + panelda toggle, lekin mavjud jadvalga ustun
 * qo'shish prodda qo'lda migratsiya talab qiladi (`scripts/db-ensure.ts` faqat
 * butunlay yangi jadvalni o'zi qo'sha oladi).
 */
